...
const char *wifi_password = "bobleboss";
...
const char *client_id = "TD06_GP05";
...
void setup()
{
  ...
  {
    mqtt_client.publish("TD06_GP05/temp", String(temp_measure).c_str());
    mqtt_client.publish("TD06_GP05/relhum", String(relative_humidity_measure).c_str());
  }
